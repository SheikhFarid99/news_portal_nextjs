...
const SimpleDetailsNewCard = ({ type, height }) => {
  return (
      ...
      <div className="p-5">
        ...
        {type === "details-news" && (
          <p className="text-sm text-slate-600 pt-3">
            ...
            helped Sri Lanka post 344/9 in Hyderabad on Tuesday (October 10).
            Mendis set a record enroute his stunning ton as he brought up three
            figures off just 65 balls - the fastest by a Sri Lankan in World
            Cups. He found support at the start from opener Pathum N
          </p>
        )}
      </div>
    </div>
